...
export default function App() {
  ...
  // Row height for daily table (px) — very tight
  const RH = 11;
  ...
  return (
    <div style={{ fontFamily:"Arial, sans-serif", background:"#e8e8e8", padding:"6px" }}>
      ...
      <style>{`
        * { box-sizing:border-box; }
        ...
        @media print {
          ...
          /* The entire form is placed inside a fixed 277mm × 190mm box
             then scaled so it always fits on exactly 1 page */
          #pg {
            position:fixed!important;
            top:0!important; left:0!important;
            /* 277mm wide at 96dpi ≈ 1047px — we lay out at 1040px then scale to fill */
            width:1047px!important;
            height:742px!important;          /* 196mm */
            overflow:hidden!important;
            transform-origin:top left!important;
            transform:scale(1.0)!important;  /* browser auto-scales to page */
      ...
      {/* ══════════════════════════════════════════════════════
          #pg  —  this entire div is what prints on ONE page
      ══════════════════════════════════════════════════════ */}
      <div id="pg" style={{ background:"#fff", fontSize:9, padding:"5px 8px", width:"100%", color:"#000" }}>
        <div style={{ border:"2px solid #000", padding:"3px 5px" }}>
          ...
          <table style={{ width:"100%", marginBottom:1 }}><tbody><tr>
            <td style={{ width:"10%", fontSize:"0.85em", color:"#555", lineHeight:1.2 }}>
            ...
            <td style={{ width:"15%", textAlign:"right", fontSize:"0.8em", color:"#555" }}>RICE &nbsp;EGGS &nbsp;CHIKKI &nbsp;RAGI &nbsp;JAGGERY</td>
          </tr></tbody></table>
          ...
          {/* ── Info + Balance table ── */}
          <table style={{ width:"100%", marginBottom:2 }}><tbody><tr valign="top">
            <td style={{ width:"33%" }}>
              <table><tbody>
            ...
            <td style={{ width:"67%", paddingLeft:5 }}>
              <table style={{ width:"100%", border:"1px solid #888", fontSize:"0.88em" }}>
                <thead>
          ...
          {/* ── Daily table ── */}
          <table style={{ tableLayout:"fixed", width:"100%", border:"1px solid #000", fontSize:"0.88em", lineHeight:"1" }}>
            <colgroup>
          ...
          {/* ── Bottom: Class-wise  |  Signatures  (side by side) ── */}
          <table style={{ width:"100%", marginTop:3 }}><tbody><tr valign="top">

            {/* Class-wise */}
            <td style={{ width:"52%", paddingRight:6 }}>
            ...
            {/* Signatures */}
            <td style={{ width:"48%", fontSize:"0.88em" }}>
